...
describe('A Command Router', () =>
{
    describe('A ExtractMessage method', () =>
    {
        it('should extract the command string when only the command is passed', () =>
        {
            ...
            var forumHost: string = '';
            var gameServerStatus: ServerStatus.ServerStatus = null;
            var websiteServerStatus: ServerStatus.ServerStatus = null;
            var forumServerStatus: ServerStatus.ServerStatus = null;
            var vehiclePrices: VehiclePrices.VehiclePrices = null;
            var commandRouter: CommandRouter.CommandRouter = new CommandRouter.CommandRouter(ircClient, commandMaps, gameServerStatus, websiteServerStatus, forumServerStatus, vehiclePrices);
